<template>
  <el-container class="home-container">
    ...
    <el-header>
      ...
      <div>
        <el-button type="info" @click="userend">用户端</el-button>
        ...
        return {
          ...
          menulist: [{
              ...
              children: [
                  ...
                  {id: 1022, authName: '部门用户', path: 'deptusers'},
                  { id: 1023, authName: '部门历史会议', path: 'depHistory' }
              ]
              },
              {
              id: 103,
              ...
              },
              {
                ...
                path: 'null',
                children: [
                  { id: 1041, authName: '日志查看', path:'log'}
                ]
              }],
            iconsObj: {
                101: 'iconfont icon-meeting',
                102: 'iconfont icon-department',
                103: 'iconfont icon-line-examine',
                104: 'iconfont icon-journal',
                1011: 'el-icon-info',
                1012: 'el-icon-date',
                1021: 'el-icon-info',
                1022: 'el-icon-s-custom',
                1023: 'el-icon-date',
                1032: 'el-icon-folder-opened',
                1031: 'el-icon-folder-checked',
                1041: 'el-icon-tickets'
            },
            isCollapse: false,
            activePath: ''
        }
